...
public class SalesReceiptEcopyForm extends AbstractPanel {
    ...
    public SalesReceiptEcopyForm() {
        super(SalesReceiptEcopyForm.class.getResource("sales_receipt_ecopy.fxml"));
    }
