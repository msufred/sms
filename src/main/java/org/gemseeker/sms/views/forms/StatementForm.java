...
public class StatementForm extends AbstractPanel {
    ...
    public StatementForm() {
        super(StatementForm.class.getResource("billing_statement.fxml"));
    }
    ...
    private void fillUpFields() {
        ...
        lblContact.setText(mAccount.getPhone());
